const blogMetadata = [
...

  {
    ...
    description:
      "A complete first-principles guide covering 30 Java concepts across OOP, type system, concurrency, and JDBC — everything you need to understand Spring Boot deeply, not just use it. From classes and interfaces to reflection, thread safety, JPA internals, and the IoC container.",
